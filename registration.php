                ...
                <div class="card background-reg ">
                    ...
                    <form class="p-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" placeholder="Enter your mobile no" name="number">
                        </div>
                        <!-- number input end  -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <!-- confirm password  -->
                            ...
                            <input type="password" placeholder="Re-enter your password" class="form-control" name="password" id="confirmPassword" onkeyup="verify()">
                            <!-- display none is use to hide <p></p> -->
